...
//可嵌套别的布局 的 RadioGroup
public class InclusiveRadioGroup extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public InclusiveRadioGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public InclusiveRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     *  mCheckedId the default checked radio button's id, if none use -1
     */
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(InclusiveRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(InclusiveRadioGroup.class.getName());
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(InclusiveRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == InclusiveRadioGroup.this ) {
                List<RadioButton> btns = getAllRadioButton(child);
                if(btns != null && btns.size() > 0){
